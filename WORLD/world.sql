...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2020 at 03:35 PM
...
CREATE TABLE `city` (
  `City_num` int(5) NOT NULL,
  `City_name` varchar(52) DEFAULT NULL,
  `Con_Code` char(3) DEFAULT NULL,
...
INSERT INTO `city` (`City_num`, `City_name`, `Con_Code`, `Province`, `Population`) VALUES
...
CREATE TABLE `country` (
  ...
  `CONTINENT` char(13) DEFAULT NULL,
  `REGION_IN_CON` varchar(10) DEFAULT NULL,
  `AREA_O_CON` float DEFAULT NULL,
  `DATE_FORMED` int(5) DEFAULT NULL,
  `POPULATION` int(10) DEFAULT NULL,
  `LIFE_EXPECTANCY` float DEFAULT NULL,
  `BIRTH_PER_YEAR` int(10) DEFAULT NULL,
  `DEATH_PER_YEAR` int(10) DEFAULT NULL,
  `LOCAL_NAME` varchar(255) DEFAULT NULL,
  `GOV_TYPE` varchar(255) DEFAULT NULL,
  `CURRENT_RULER` varchar(255) DEFAULT NULL,
  `CAPITAL_CITY_INDEX` int(5) DEFAULT NULL,
  `COUNTRY_ABBREVIATE` char(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `country` (`CON_CODE`, `CON_NAME`, `CONTINENT`, `REGION_IN_CON`, `AREA_O_CON`, `DATE_FORMED`, `POPULATION`, `LIFE_EXPECTANCY`, `BIRTH_PER_YEAR`, `DEATH_PER_YEAR`, `LOCAL_NAME`, `GOV_TYPE`, `CURRENT_RULER`, `CAPITAL_CITY_INDEX`, `COUNTRY_ABBREVIATE`) VALUES
('AFG', 'Afghanistan', 'Asia', 'Southern a', 652090, 1919, 22720000, 45.9, 5976, 0, 'Afganistan/Afqanestan', 'Islamic Emirate', 'Mohammad Omar', 1, 'AF'),
('AGG', 'Angola', 'Africa', 'Central Af', 1246700, 1975, 12878000, 38.3, 6648, 7984, 'Angola', 'Republic', 'José Eduardo dos Santos', 56, 'AO'),
('AIA', 'Anguilla', 'North America', 'Caribbean', 96, 123, 8000, 76.1, 63, 0, 'Anguilla', 'Dependent Territory of the UK', 'Elisabeth II', 62, 'AI'),
('ALB', 'Albania', 'Europe', 'Southern E', 28748, 1912, 3401200, 71.6, 3205, 2500, 'Shqipëria', 'Republic', 'Rexhep Mejdani', 34, 'AL'),
('AND', 'Andorra', 'Europe', 'Southern E', 468, 1278, 78000, 83.5, 1630, 0, 'Andorra', 'Parliamentary Coprincipality', NULL, 55, 'AD'),
...
('ARG', 'Argentina', 'South America', 'South Amer', 2780400, 1816, 37032000, 75.1, 340238, 323310, 'Argentina', 'Federal Republic', 'Fernando de la Rúa', 69, 'AR'),
('ARK', 'Armenia', 'Asia', 'Middle Eas', 29800, 1991, 3520000, 66.4, 1813, 1627, 'Hajastan', 'Republic', 'Robert Kotšarjan', 126, 'AM'),
...
('AUS', 'Australia', 'Oceania', 'Australia ', 7741220, 1901, 18886000, 79.8, 351182, 392911, 'Australia', 'Constitutional Monarchy, Federation', 'Elisabeth II', 135, 'AU'),
('AUT', 'Austria', 'Europe', 'Western Eu', 83859, 1918, 8091800, 77.7, 211860, 206025, 'Österreich', 'Federal Republic', 'Thomas Klestil', 1523, 'AT'),
('AZE', 'Azerbaijan', 'Asia', 'Middle Eas', 86600, 1991, 7734000, 62.9, 4127, 4100, 'Azärbaycan', 'Federal Republic', 'Heydär Äliyev', 144, 'AZ'),
('BDI', 'Burundi', 'Africa', 'Eastern Af', 27834, 1962, 6695000, 46.2, 903, 982, 'Burundi/Uburundi', 'Republic', 'Pierre Buyoya', 552, 'BI'),
('BEL', 'Belgium', 'Europe', 'Western Eu', 30518, 1830, 10239000, 77.8, 249704, 243948, 'België/Belgique', 'Constitutional Monarchy, Federation', 'Albert II', 179, 'BE'),
('BEN', 'Benin', 'Africa', 'Western Af', 112622, 1960, 6097000, 50.2, 2357, 2141, 'Bénin', 'Republic', 'Mathieu Kérékou', 187, 'BJ'),
('BFA', 'Burkina Faso', 'Africa', 'Western Af', 274000, 1960, 11937000, 46.7, 2425, 2201, 'Burkina Faso', 'Republic', 'Blaise Compaoré', 549, 'BF'),
('BGD', 'Bangladesh', 'Asia', 'Southern a', 143998, 1971, 129155000, 60.2, 32852, 31966, 'Bangladesh', 'Republic', 'Shahabuddin Ahmad', 150, 'BD'),
('BGR', 'Bulgaria', 'Europe', 'Eastern Eu', 110994, 1908, 8190900, 70.9, 12178, 10169, 'Balgarija', 'Republic', 'Petar Stojanov', 539, 'BG'),
('BHR', 'Bahrain', 'Asia', 'Middle Eas', 694, 1971, 617000, 73, 6366, 6097, 'Al-Bahrayn', 'Monarchy (Emirate)', 'Hamad ibn Isa al-Khalifa', 149, 'BH'),
...
('BIH', 'Bosnia and Herzegovina', 'Europe', 'Southern E', 51197, 1992, 3972000, 71.5, 2841, 0, 'Bosna i Hercegovina', 'Federal Republic', 'Ante Jelavic', 201, 'BA'),
('BLR', 'Belarus', 'Europe', 'Eastern Eu', 207600, 1991, 10236000, 68, 13714, 0, 'Belarus', 'Republic', 'Aljaksandr Lukašenka', 3520, 'BY'),
('BLZ', 'Belize', 'North America', 'Central Am', 22696, 1981, 241000, 70.9, 630, 616, 'Belize', 'Constitutional Monarchy', 'Elisabeth II', 185, 'BZ'),
('BMU', 'Bermuda', 'North America', 'North Amer', 53, 0, 65000, 76.9, 2328, 2190, 'Bermuda', 'Dependent Territory of the UK', 'Elisabeth II', 191, 'BM'),
('BOL', 'Bolivia', 'South America', 'South Amer', 1098580, 1825, 8329000, 63.7, 8571, 7967, 'Bolivia', 'Republic', 'Hugo Bánzer Suárez', 194, 'BO'),
('BRA', 'Brazil', 'South America', 'South Amer', 8547400, 1822, 170115000, 62.9, 776739, 804108, 'Brasil', 'Federal Republic', 'Fernando Henrique Cardoso', 211, 'BR'),
('BRB', 'Barbados', 'North America', 'Caribbean', 430, 1966, 270000, 73, 2223, 2186, 'Barbados', 'Constitutional Monarchy', 'Elisabeth II', 174, 'BB'),
('BRN', 'Brunei', 'Asia', 'Southeast ', 5765, 1984, 328000, 73.6, 11705, 12460, 'Brunei Darussalam', 'Monarchy (Sultanate)', 'Haji Hassan al-Bolkiah', 538, 'BN'),
('BTN', 'Bhutan', 'Asia', 'Southern a', 47000, 1910, 2124000, 52.4, 372, 383, 'Druk-Yul', 'Monarchy', 'Jigme Singye Wangchuk', 192, 'BT'),
('BVT', 'Bouvet Island', 'Antarctica', 'Antarctica', 59, 0, 0, 0, 0, 0, 'Bouvetøya', 'Dependent Territory of Norway', 'Harald V', 0, 'BV'),
('BWA', 'Botswana', 'Africa', 'Southern A', 581730, 1966, 1622000, 39.3, 4834, 4935, 'Botswana', 'Republic', 'Festus G. Mogae', 204, 'BW'),
('CAF', 'Central African Republic', 'Africa', 'Central Af', 622984, 1960, 3615000, 44, 1054, 993, 'Centrafrique/Bê-Afrîka', 'Republic', 'Ange-Félix Patassé', 1889, 'CF'),
('CAN', 'Canada', 'North America', 'North Amer', 9970610, 1867, 31147000, 79.4, 598862, 625626, 'Canada', 'Constitutional Monarchy, Federation', 'Elisabeth II', 1822, 'CA'),
('CCK', 'Cocos (Keeling) Islands', 'Oceania', 'Australia ', 14, 0, 600, 0, 0, 0, 'Cocos (Keeling) Islands', 'Territory of Australia', 'Elisabeth II', 2317, 'CC'),
('CHE', 'Switzerland', 'Europe', 'Western Eu', 41284, 1499, 7160400, 79.6, 264478, 256092, 'Schweiz/Suisse/Svizzera/Svizra', 'Federation', 'Adolf Ogi', 3248, 'CH'),
('CHL', 'Chile', 'South America', 'South Amer', 756626, 1810, 15211000, 75.7, 72949, 75780, 'Chile', 'Republic', 'Ricardo Lagos Escobar', 554, 'CL'),
('CHN', 'China', 'Asia', 'Eastern As', 9572900, -1523, 1277558000, 71.4, 982268, 917719, 'Zhongquo', 'People\'sRepublic', 'Jiang Zemin', 1891, 'CN'),
('CIV', 'Côte d’Ivoire', 'Africa', 'Western Af', 322463, 1960, 14786000, 45.2, 11345, 10285, 'Côte d’Ivoire', 'Republic', 'Laurent Gbagbo', 2814, 'CI'),
('CMR', 'Cameroon', 'Africa', 'Central Af', 475442, 1960, 15085000, 54.8, 9174, 8596, 'Cameroun/Cameroon', 'Republic', 'Paul Biya', 1804, 'CM'),
('COD', 'Congo, The Democratic Republic of the', 'Africa', 'Central Af', 2344860, 1960, 51654000, 48.8, 6964, 2474, 'République Démocratique du Congo', 'Republic', 'Joseph Kabila', 2298, 'CD'),
('COG', 'Congo', 'Africa', 'Central Af', 342000, 1960, 2943000, 47.4, 2108, 2287, 'Congo', 'Republic', 'Denis Sassou-Nguesso', 2296, 'CG'),
...
('COL', 'Colombia', 'South America', 'South Amer', 1138910, 1810, 42321000, 70.3, 102896, 105116, 'Colombia', 'Republic', 'Andrés Pastrana Arango', 2257, 'CO'),
('COM', 'Comoros', 'Africa', 'Eastern Af', 1862, 1975, 578000, 60, 4401, 4361, 'Komori/Comores', 'Republic', 'Azali Assoumani', 2295, 'KM'),
('CPV', 'Cape Verde', 'Africa', 'Western Af', 4033, 1975, 428000, 68.9, 435, 420, 'Cabo Verde', 'Republic', 'António Mascarenhas Monteiro', 1859, 'CV'),
('CRI', 'Costa Rica', 'North America', 'Central Am', 51100, 1821, 4023000, 75.8, 10226, 9757, 'Costa Rica', 'Republic', 'Miguel Ángel Rodríguez Echeverría', 584, 'CR'),
...
('CXR', 'Christmas Island', 'Oceania', 'Australia ', 135, 0, 2500, 0, 0, 0, 'Christmas Island', 'Territory of Australia', 'Elisabeth II', 1791, 'CX'),
...
('CYP', 'Cyprus', 'Asia', 'Middle Eas', 9251, 1960, 754700, 76.7, 9333, 8246, 'Kýpros/Kibris', 'Republic', 'Glafkos Klerides', 2430, 'CY'),
('CZE', 'Czech Republic', 'Europe', 'Eastern Eu', 78866, 1993, 10278100, 74.5, 55017, 52037, '¸esko', 'Republic', 'Václav Havel', 3339, 'CZ'),
('DEU', 'Germany', 'Europe', 'Western Eu', 357022, 1955, 82164700, 77.4, 2133367, 2102826, 'Deutschland', 'Federal Republic', 'Johannes Rau', 3068, 'DE'),
('DJI', 'Djibouti', 'Africa', 'Eastern Af', 23200, 1977, 638000, 50.8, 382, 373, 'Djibouti/Jibuti', 'Republic', 'Ismail Omar Guelleh', 585, 'DJ'),
('DMA', 'Dominica', 'North America', 'Caribbean', 751, 1978, 71000, 73.4, 256, 243, 'Dominica', 'Republic', 'Vernon Shaw', 586, 'DM'),
('DNK', 'Denmark', 'Europe', 'Nordic Cou', 43094, 800, 5330000, 76.5, 174099, 169264, 'Danmark', 'Constitutional Monarchy', 'Margrethe II', 3315, 'DK'),
...
('DZA', 'Algeria', 'Africa', 'Northern A', 2381740, 1962, 31471000, 69.7, 49982, 46966, 'Al-Jaza’ir/Algérie', 'Republic', 'Abdelaziz Bouteflika', 35, 'DZ'),
('ECU', 'Ecuador', 'South America', 'South Amer', 283561, 1822, 12646000, 71.1, 19770, 19769, 'Ecuador', 'Republic', 'Gustavo Noboa Bejarano', 594, 'EC'),
('EGY', 'Egypt', 'Africa', 'Northern A', 1001450, 1922, 68470000, 63.3, 82710, 75617, 'Misr', 'Republic', 'Hosni Mubarak', 608, 'EG'),
('ERI', 'Eritrea', 'Africa', 'Eastern Af', 117600, 1993, 3850000, 55.8, 650, 755, 'Ertra', 'Republic', 'Isayas Afewerki [Isaias Afwerki]', 652, 'ER'),
('ESH', 'Western Sahara', 'Africa', 'Northern A', 266000, 0, 293000, 49.8, 60, 0, 'As-Sahrawiya', 'Occupied by Marocco', 'Mohammed Abdel Aziz', 2453, 'EH'),
('ESP', 'Spain', 'Europe', 'Southern E', 505992, 1492, 39441700, 78.8, 553233, 532031, 'España', 'Constitutional Monarchy', 'Juan Carlos I', 653, 'ES'),
('EST', 'Estonia', 'Europe', 'Baltic Cou', 45227, 1991, 1439200, 69.5, 5328, 3371, 'Eesti', 'Republic', 'Lennart Meri', 3791, 'EE'),
('ETH', 'Ethiopia', 'Africa', 'Eastern Af', 1104300, -1000, 62565000, 45.2, 6353, 6180, 'YeItyop´iya', 'Republic', 'Negasso Gidada', 756, 'ET'),
('FIN', 'Finland', 'Europe', 'Nordic Cou', 338145, 1917, 5171300, 77.4, 121914, 119833, 'Suomi', 'Republic', 'Tarja Halonen', 3236, 'FI'),
('FJI', 'Fiji Islands', 'Oceania', 'Melanesia', 18274, 1970, 817000, 67.9, 1536, 2149, 'Fiji Islands', 'Republic', 'Josefa Iloilo', 764, 'FJ'),
('FLK', 'Falkland Islands', 'South America', 'South Amer', 12173, 0, 2000, 0, 0, 0, 'Falkland Islands', 'Dependent Territory of the UK', 'Elisabeth II', 763, 'FK'),
('FRA', 'France', 'Europe', 'Western Eu', 551500, 843, 59225700, 78.8, 1424285, 1392448, 'France', 'Republic', 'Jacques Chirac', 2974, 'FR'),
('FRO', 'Faroe Islands', 'Europe', 'Nordic Cou', 1399, 0, 43000, 78.4, 0, 0, 'Føroyar', 'Part of Denmark', 'Margrethe II', 901, 'FO'),
...
('GAB', 'Gabon', 'Africa', 'Central Af', 267668, 1960, 1226000, 50.1, 5493, 5279, 'Le Gabon', 'Republic', 'Omar Bongo', 902, 'GA'),
('GBR', 'United Kingdom', 'Europe', 'British Is', 242900, 1066, 59623400, 77.7, 1378330, 1296830, 'United Kingdom', 'Constitutional Monarchy', 'Elisabeth II', 456, 'GB'),
('GEO', 'Georgia', 'Asia', 'Middle Eas', 69700, 1991, 4968000, 64.5, 6064, 5924, 'Sakartvelo', 'Republic', 'Eduard Ševardnadze', 905, 'GE'),
('GHA', 'Ghana', 'Africa', 'Western Af', 238533, 1957, 20212000, 57.4, 7137, 6884, 'Ghana', 'Republic', 'John Kufuor', 910, 'GH'),
('GIB', 'Gibraltar', 'Europe', 'Southern E', 6, 0, 25000, 79, 258, 0, 'Gibraltar', 'Dependent Territory of the UK', 'Elisabeth II', 915, 'GI'),
('GIN', 'Guinea', 'Africa', 'Western Af', 245857, 1958, 7430000, 45.6, 2352, 2383, 'Guinée', 'Republic', 'Lansana Conté', 926, 'GN'),
...
('GMB', 'Gambia', 'Africa', 'Western Af', 11295, 1965, 1305000, 53.2, 320, 325, 'The Gambia', 'Republic', 'Yahya Jammeh', 904, 'GM'),
('GNB', 'Guinea-Bissau', 'Africa', 'Western Af', 36125, 1974, 1213000, 49, 293, 272, 'Guiné-Bissau', 'Republic', 'Kumba Ialá', 927, 'GW'),
('GNQ', 'Equatorial Guinea', 'Africa', 'Central Af', 28051, 1968, 453000, 53.6, 283, 542, 'Guinea Ecuatorial', 'Republic', 'Teodoro Obiang Nguema Mbasogo', 2972, 'GQ'),
('GRC', 'Greece', 'Europe', 'Southern E', 131626, 1830, 10545700, 78.4, 120724, 119946, 'Elláda', 'Republic', 'Kostis Stefanopoulos', 2401, 'GR'),
('GRD', 'Grenada', 'North America', 'Caribbean', 344, 1974, 94000, 64.5, 318, 0, 'Grenada', 'Constitutional Monarchy', 'Elisabeth II', 916, 'GD'),
('GRL', 'Greenland', 'North America', 'North Amer', 2166090, 0, 56000, 68.1, 0, 0, 'Kalaallit Nunaat/Grønland', 'Part of Denmark', 'Margrethe II', 917, 'GL'),
('GTM', 'Guatemala', 'North America', 'Central Am', 108889, 1821, 11385000, 66.2, 19008, 17797, 'Guatemala', 'Republic', 'Alfonso Portillo Cabrera', 922, 'GT'),
('GUF', 'French Guiana', 'South America', 'South Amer', 90000, 0, 181000, 76.1, 681, 0, 'Guyane française', 'Overseas Department of France', 'Jacques Chirac', 3014, 'GF'),
('GUM', 'Guam', 'Oceania', 'Micronesia', 549, 0, 168000, 77.8, 1197, 1136, 'Guam', 'US Territory', 'George W. Bush', 921, 'GU'),
('GUY', 'Guyana', 'South America', 'South Amer', 214969, 1966, 861000, 64, 722, 743, 'Guyana', 'Republic', 'Bharrat Jagdeo', 928, 'GY'),
('HKG', 'Hong Kong', 'Asia', 'Eastern As', 1075, 0, 6782000, 79.5, 166448, 173610, 'Xianggang/Hong Kong', 'Special Administrative Region of China', 'Jiang Zemin', 937, 'HK'),
...
('HND', 'Honduras', 'North America', 'Central Am', 112088, 1838, 6485000, 69.9, 5333, 4697, 'Honduras', 'Republic', 'Carlos Roberto Flores Facussé', 933, 'HN'),
('HRV', 'Croatia', 'Europe', 'Southern E', 56538, 1991, 4473000, 73.7, 20208, 19300, 'Hrvatska', 'Republic', 'Štipe Mesic', 2409, 'HR'),
('HTI', 'Haiti', 'North America', 'Caribbean', 27750, 1804, 8222000, 49.2, 3459, 3107, 'Haïti/Dayti', 'Republic', 'Jean-Bertrand Aristide', 929, 'HT'),
('HUN', 'Hungary', 'Europe', 'Eastern Eu', 93030, 1918, 10043200, 71.4, 48267, 45914, 'Magyarország', 'Republic', 'Ferenc Mádl', 3483, 'HU'),
('IDN', 'Indonesia', 'Asia', 'Southeast ', 1904570, 1945, 212107000, 68, 84982, 215002, 'Indonesia', 'Republic', 'Abdurrahman Wahid', 939, 'ID'),
('IND', 'India', 'Asia', 'Southern a', 3287260, 1947, 1013662000, 62.5, 447114, 430572, 'Bharat/India', 'Federal Republic', 'Kocheril Raman Narayanan', 1109, 'IN'),
('IOT', 'British Indian Ocean Territory', 'Africa', 'Eastern Af', 78, 0, 0, 0, 0, 0, 'British Indian Ocean Territory', 'Dependent Territory of the UK', 'Elisabeth II', 0, 'IO'),
('IRL', 'Ireland', 'Europe', 'British Is', 70273, 1921, 3775100, 76.8, 75921, 73132, 'Ireland/Éire', 'Republic', 'Mary McAleese', 1447, 'IE'),
('IRN', 'Iran', 'Asia', 'Southern a', 1648200, 1906, 67702000, 69.7, 195746, 160151, 'Iran', 'Islamic Republic', 'Ali Mohammad Khatami-Ardakani', 1380, 'IR'),
('IRQ', 'Iraq', 'Asia', 'Middle Eas', 438317, 1932, 23115000, 66.5, 11500, 0, 'Al-´Iraq', 'Republic', 'Saddam Hussein al-Takriti', 1365, 'IQ'),
('ISL', 'Iceland', 'Europe', 'Nordic Cou', 103000, 1944, 279000, 79.4, 8255, 7474, 'Ísland', 'Republic', 'Ólafur Ragnar Grímsson', 1449, 'IS'),
('ISR', 'Israel', 'Asia', 'Middle Eas', 21056, 1948, 6217000, 78.6, 97477, 98577, 'Yisra’el/Isra’il', 'Republic', 'Moshe Katzav', 1450, 'IL'),
('ITA', 'Italy', 'Europe', 'Southern E', 301316, 1861, 57680000, 79, 1161755, 1145372, 'Italia', 'Republic', 'Carlo Azeglio Ciampi', 1464, 'IT'),
...
('JOR', 'Jordan', 'Asia', 'Middle Eas', 88946, 1946, 5083000, 77.4, 7526, 7051, 'Al-Urdunn', 'Constitutional Monarchy', 'Abdullah II', 1786, 'JO'),
('JPN', 'Japan', 'Asia', 'Eastern As', 377829, -660, 126714000, 80.7, 3787042, 4192638, 'Nihon/Nippon', 'Constitutional Monarchy', 'Akihito', 1532, 'JP'),
('KAZ', 'Kazakstan', 'Asia', 'Southern a', 2724900, 1991, 16223000, 63.2, 24375, 23383, 'Qazaqstan', 'Republic', 'Nursultan Nazarbajev', 1864, 'KZ'),
('KEN', 'Kenya', 'Africa', 'Eastern Af', 580367, 1963, 30080000, 48, 9217, 10241, 'Kenya', 'Republic', 'Daniel arap Moi', 1881, 'KE'),
('KGZ', 'Kyrgyzstan', 'Asia', 'Southern a', 199900, 1991, 4699000, 63.4, 1626, 1767, 'Kyrgyzstan', 'Republic', 'Askar Akajev', 2253, 'KG'),
('KHM', 'Cambodia', 'Asia', 'Southeast ', 181035, 1953, 11168000, 56.5, 5121, 5670, 'Kâmpuchéa', 'Constitutional Monarchy', 'Norodom Sihanouk', 1800, 'KH'),
...
('KOR', 'South Korea', 'Asia', 'Eastern As', 99434, 1948, 46844000, 74.4, 320749, 442544, 'Taehan Min’guk (Namhan)', 'Republic', 'Kim Dae-jung', 2331, 'KR'),
('KWT', 'Kuwait', 'Asia', 'Middle Eas', 17818, 1961, 1972000, 76.1, 27037, 30373, 'Al-Kuwayt', 'Constitutional Monarchy (Emirate)', 'Jabir al-Ahmad al-Jabir al-Sabah', 2429, 'KW'),
('LAO', 'Laos', 'Asia', 'Southeast ', 236800, 1953, 5433000, 53.1, 1292, 1746, 'Lao', 'Republic', 'Khamtay Siphandone', 2432, 'LA'),
('LBN', 'Lebanon', 'Asia', 'Middle Eas', 10400, 1941, 3282000, 71.3, 17121, 15129, 'Lubnan', 'Republic', 'Émile Lahoud', 2438, 'LB'),
('LBR', 'Liberia', 'Africa', 'Western Af', 111369, 1847, 3154000, 51, 2012, 0, 'Liberia', 'Republic', 'Charles Taylor', 2440, 'LR'),
('LBY', 'Libyan Arab Jamahiriya', 'Africa', 'Northern A', 1759540, 1951, 5605000, 75.5, 44806, 40562, 'Libiya', 'Socialistic State', 'Muammar al-Qadhafi', 2441, 'LY'),
...
('LIE', 'Liechtenstein', 'Europe', 'Western Eu', 160, 1806, 32300, 78.8, 1119, 1084, 'Liechtenstein', 'Constitutional Monarchy', 'Hans-Adam II', 2446, 'LI'),
('LKA', 'Sri Lanka', 'Asia', 'Southern a', 65610, 1948, 18827000, 71.8, 15706, 15091, 'Sri Lanka/Ilankai', 'Republic', 'Chandrika Kumaratunga', 3217, 'LK'),
('LSO', 'Lesotho', 'Africa', 'Southern A', 30355, 1966, 2153000, 50.8, 1061, 1161, 'Lesotho', 'Constitutional Monarchy', 'Letsie III', 2437, 'LS'),
('LTU', 'Lithuania', 'Europe', 'Baltic Cou', 65301, 1991, 3698500, 69.1, 10692, 9585, 'Lietuva', 'Republic', 'Valdas Adamkus', 2447, 'LT'),
('LUX', 'Luxembourg', 'Europe', 'Western Eu', 2586, 1867, 435700, 77.1, 16321, 15519, 'Luxembourg/Lëtzebuerg', 'Constitutional Monarchy', 'Henri', 2452, 'LU'),
('LVA', 'Latvia', 'Europe', 'Baltic Cou', 64589, 1991, 2424200, 68.4, 6398, 5639, 'Latvija', 'Republic', 'Vaira Vike-Freiberga', 2434, 'LV'),
('MAC', 'Macao', 'Asia', 'Eastern As', 18, 0, 473000, 81.6, 5749, 5940, 'Macau/Aomen', 'Special Administrative Region of China', 'Jiang Zemin', 2454, 'MO'),
('MAR', 'Morocco', 'Africa', 'Northern A', 446550, 1956, 28351000, 69.1, 36124, 33514, 'Al-Maghrib', 'Constitutional Monarchy', 'Mohammed VI', 2486, 'MA'),
('MCO', 'Monaco', 'Europe', 'Western Eu', 1.5, 1861, 34000, 78.8, 776, 0, 'Monaco', 'Constitutional Monarchy', 'Rainier III', 2695, 'MC'),
('MDA', 'Moldova', 'Europe', 'Eastern Eu', 33851, 1991, 4380000, 64.5, 1579, 1872, 'Moldova', 'Republic', 'Vladimir Voronin', 2690, 'MD'),
('MDG', 'Madagascar', 'Africa', 'Eastern Af', 587041, 1960, 15942000, 55, 3750, 3545, 'Madagasikara/Madagascar', 'Federal Republic', 'Didier Ratsiraka', 2455, 'MG'),
('MDV', 'Maldives', 'Asia', 'Southern a', 298, 1965, 286000, 62.2, 199, 0, 'Dhivehi Raajje/Maldives', 'Republic', 'Maumoon Abdul Gayoom', 2463, 'MV'),
('MEX', 'Mexico', 'North America', 'Central Am', 1958200, 1810, 98881000, 71.5, 414972, 401461, 'México', 'Federal Republic', 'Vicente Fox Quesada', 2515, 'MX'),
('MHL', 'Marshall Islands', 'Oceania', 'Micronesia', 181, 1990, 64000, 65.5, 97, 0, 'Marshall Islands/Majol', 'Republic', 'Kessai Note', 2507, 'MH'),
('MKD', 'Macedonia', 'Europe', 'Southern E', 25713, 1991, 2024000, 73.8, 1694, 1915, 'Makedonija', 'Republic', 'Boris Trajkovski', 2460, 'MK'),
('MLI', 'Mali', 'Africa', 'Western Af', 1240190, 1960, 11234000, 46.7, 2642, 2453, 'Mali', 'Republic', 'Alpha Oumar Konaré', 2482, 'ML'),
('MLT', 'Malta', 'Europe', 'Southern E', 316, 1964, 380200, 77.9, 3512, 3338, 'Malta', 'Republic', 'Guido de Marco', 2484, 'MT'),
('MMR', 'Myanmar', 'Asia', 'Southeast ', 676578, 1948, 45611000, 54.9, 180375, 171028, 'Myanma Pye', 'Republic', 'kenraali Than Shwe', 2710, 'MM'),
('MNG', 'Mongolia', 'Asia', 'Eastern As', 1566500, 1921, 2662000, 67.3, 1043, 933, 'Mongol Uls', 'Republic', 'Natsagiin Bagabandi', 2696, 'MN'),
...
('MOZ', 'Mozambique', 'Africa', 'Eastern Af', 801590, 1975, 19680000, 37.5, 2891, 2711, 'Moçambique', 'Republic', 'Joaquím A. Chissano', 2698, 'MZ'),
('MRT', 'Mauritania', 'Africa', 'Western Af', 1025520, 1960, 2670000, 50.8, 998, 1081, 'Muritaniya/Mauritanie', 'Republic', 'Maaouiya Ould Sid´Ahmad Taya', 2509, 'MR'),
...
('MUS', 'Mauritius', 'Africa', 'Eastern Af', 2040, 1968, 1158000, 71, 4251, 4186, 'Mauritius', 'Republic', 'Cassam Uteem', 2511, 'MU'),
('MWI', 'Malawi', 'Africa', 'Eastern Af', 118484, 1964, 10925000, 37.6, 1687, 2527, 'Malawi', 'Republic', 'Bakili Muluzi', 2462, 'MW'),
('MYS', 'Malaysia', 'Asia', 'Southeast ', 329758, 1957, 22244000, 70.8, 69213, 97884, 'Malaysia', 'Constitutional Monarchy, Federation', 'Salahuddin Abdul Aziz Shah Alhaj', 2464, 'MY'),
('MYT', 'Mayotte', 'Africa', 'Eastern Af', 373, 0, 149000, 59.5, 0, 0, 'Mayotte', 'Territorial Collectivity of France', 'Jacques Chirac', 2514, 'YT'),
('NAM', 'Namibia', 'Africa', 'Southern A', 824292, 1990, 1726000, 42.5, 3101, 3384, 'Namibia', 'Republic', 'Sam Nujoma', 2726, 'NA'),
...
('NER', 'Niger', 'Africa', 'Western Af', 1267000, 1960, 10730000, 41.3, 1706, 1580, 'Niger', 'Republic', 'Mamadou Tandja', 2738, 'NE'),
('NFK', 'Norfolk Island', 'Oceania', 'Australia ', 36, 0, 2000, 0, 0, 0, 'Norfolk Island', 'Territory of Australia', 'Elisabeth II', 2806, 'NF'),
('NGA', 'Nigeria', 'Africa', 'Western Af', 923768, 1960, 111506000, 51.6, 65707, 58623, 'Nigeria', 'Federal Republic', 'Olusegun Obasanjo', 2754, 'NG'),
('NIC', 'Nicaragua', 'North America', 'Central Am', 130000, 1838, 5074000, 68.7, 1988, 2023, 'Nicaragua', 'Republic', 'Arnoldo Alemán Lacayo', 2734, 'NI'),
('NIU', 'Niue', 'Oceania', 'Polynesia', 260, 0, 2000, 0, 0, 0, 'Niue', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 2805, 'NU'),
('NLD', 'Netherlands', 'Europe', 'Western Eu', 41526, 1581, 15864000, 78.3, 371362, 360478, 'Nederland', 'Constitutional Monarchy', 'Beatrix', 5, 'NL'),
('NOR', 'Norway', 'Europe', 'Nordic Cou', 323877, 1905, 4478500, 78.7, 145895, 153370, 'Norge', 'Constitutional Monarchy', 'Harald V', 2807, 'NO'),
('NPL', 'Nepal', 'Asia', 'Southern a', 147181, 1769, 23930000, 57.8, 4768, 4837, 'Nepal', 'Constitutional Monarchy', 'Gyanendra Bir Bikram', 2729, 'NP'),
('NRU', 'Nauru', 'Oceania', 'Micronesia', 21, 1968, 12000, 60.8, 197, 0, 'Naoero/Nauru', 'Republic', 'Bernard Dowiyogo', 2728, 'NR'),
('NZL', 'New Zealand', 'Oceania', 'Australia ', 270534, 1907, 3862000, 77.8, 54669, 64960, 'New Zealand/Aotearoa', 'Constitutional Monarchy', 'Elisabeth II', 3499, 'NZ'),
('OMN', 'Oman', 'Asia', 'Middle Eas', 309500, 1951, 2542000, 71.8, 16904, 16153, '´Uman', 'Monarchy (Sultanate)', 'Qabus ibn Sa´id', 2821, 'OM'),
('PAK', 'Pakistan', 'Asia', 'Southern a', 796095, 1947, 156483000, 61.1, 61289, 58549, 'Pakistan', 'Republic', 'Mohammad Rafiq Tarar', 2831, 'PK'),
('PAN', 'Panama', 'North America', 'Central Am', 75517, 1903, 2856000, 75.5, 9131, 8700, 'Panamá', 'Republic', 'Mireya Elisa Moscoso Rodríguez', 2882, 'PA'),
('PCN', 'Pitcairn', 'Oceania', 'Polynesia', 49, 0, 50, 0, 0, 0, 'Pitcairn', 'Dependent Territory of the UK', 'Elisabeth II', 2912, 'PN'),
('PER', 'Peru', 'South America', 'South Amer', 1285220, 1821, 25662000, 70, 64140, 65186, 'Perú/Piruw', 'Republic', 'Valentin Paniagua Corazao', 2890, 'PE'),
('PHL', 'Philippines', 'Asia', 'Southeast ', 300000, 1946, 75967000, 67.5, 65107, 82239, 'Pilipinas', 'Republic', 'Gloria Macapagal-Arroyo', 766, 'PH'),
...
('POL', 'Poland', 'Europe', 'Eastern Eu', 323250, 1918, 38653600, 73.2, 151697, 135636, 'Polska', 'Republic', 'Aleksander Kwasniewski', 2928, 'PL'),
...
('PRK', 'North Korea', 'Asia', 'Eastern As', 120538, 1948, 24039000, 70.7, 5332, 0, 'Choson Minjujuui In´min Konghwaguk (Bukhan)', 'Socialistic Republic', 'Kim Jong-il', 2318, 'KP'),
('PRT', 'Portugal', 'Europe', 'Southern E', 91982, 1143, 9997600, 75.8, 105954, 102133, 'Portugal', 'Republic', 'Jorge Sampãio', 2914, 'PT'),
('PRY', 'Paraguay', 'South America', 'South Amer', 406752, 1811, 5496000, 73.7, 8444, 9555, 'Paraguay', 'Republic', 'Luis Ángel González Macchi', 2885, 'PY'),
('PSE', 'Palestine', 'Asia', 'Middle Eas', 6257, 0, 3101000, 71.4, 4173, 0, 'Filastin', 'Autonomous Area', 'Yasser (Yasir) Arafat', 4074, 'PS'),
...
('QAT', 'Qatar', 'Asia', 'Middle Eas', 11000, 1971, 599000, 72.4, 9472, 8920, 'Qatar', 'Monarchy', 'Hamad ibn Khalifa al-Thani', 2973, 'QA'),
('REU', 'Réunion', 'Africa', 'Eastern Af', 2510, 0, 699000, 72.7, 8287, 7988, 'Réunion', 'Overseas Department of France', 'Jacques Chirac', 3017, 'RE'),
('ROM', 'Romania', 'Europe', 'Eastern Eu', 238391, 1878, 22455500, 69.9, 38158, 34843, 'România', 'Republic', 'Ion Iliescu', 3018, 'RO'),
('RUS', 'Russian Federation', 'Europe', 'Eastern Eu', 17075400, 1991, 146934000, 67.2, 276608, 442989, 'Rossija', 'Federal Republic', 'Vladimir Putin', 3580, 'RU'),
('RWA', 'Rwanda', 'Africa', 'Eastern Af', 26338, 1962, 7733000, 39.3, 2036, 1863, 'Rwanda/Urwanda', 'Republic', 'Paul Kagame', 3047, 'RW'),
('SAU', 'Saudi Arabia', 'Asia', 'Middle Eas', 2149690, 1932, 21607000, 67.8, 137635, 146171, 'Al-´Arabiya as-Sa´udiya', 'Monarchy', 'Fahd ibn Abdul-Aziz al-Sa´ud', 3173, 'SA'),
('SDN', 'Sudan', 'Africa', 'Northern A', 2505810, 1956, 29490000, 56.6, 10162, 0, 'As-Sudan', 'Islamic Republic', 'Omar Hassan Ahmad al-Bashir', 3225, 'SD'),
('SEN', 'Senegal', 'Africa', 'Western Af', 196722, 1960, 9481000, 62.2, 4787, 4542, 'Sénégal/Sounougal', 'Republic', 'Abdoulaye Wade', 3198, 'SN'),
('SGP', 'Singapore', 'Asia', 'Southeast ', 618, 1965, 3567000, 80.1, 86503, 96318, 'Singapore/Singapura/Xinjiapo/Singapur', 'Republic', 'Sellapan Rama Nathan', 3208, 'SG'),
...
('SHN', 'Saint Helena', 'Africa', 'Western Af', 314, 0, 6000, 76.8, 0, 0, 'Saint Helena', 'Dependent Territory of the UK', 'Elisabeth II', 3063, 'SH'),
('SJM', 'Svalbard and Jan Mayen', 'Europe', 'Nordic Cou', 62422, 0, 3200, 0, 0, 0, 'Svalbard og Jan Mayen', 'Dependent Territory of Norway', 'Harald V', 938, 'SJ'),
...
('SLE', 'Sierra Leone', 'Africa', 'Western Af', 71740, 1961, 4854000, 45.3, 746, 858, 'Sierra Leone', 'Republic', 'Ahmed Tejan Kabbah', 3207, 'SL'),
('SLV', 'El Salvador', 'North America', 'Central Am', 21041, 1841, 6276000, 69.7, 11863, 11203, 'El Salvador', 'Republic', 'Francisco Guillermo Flores Pérez', 645, 'SV'),
('SMR', 'San Marino', 'Europe', 'Southern E', 61, 885, 27000, 81.1, 510, 0, 'San Marino', 'Republic', 'NULL', 3171, 'SM'),
('SOM', 'Somalia', 'Africa', 'Eastern Af', 637657, 1960, 10097000, 46.2, 935, 0, 'Soomaaliya', 'Republic', 'Abdiqassim Salad Hassan', 3214, 'SO'),
('SPM', 'Saint Pierre and Miquelon', 'North America', 'North Amer', 242, 0, 7000, 77.6, 0, 0, 'Saint-Pierre-et-Miquelon', 'Territorial Collectivity of France', 'Jacques Chirac', 3067, 'PM'),
('STP', 'Sao Tome and Principe', 'Africa', 'Central Af', 964, 1975, 147000, 65.3, 6, 0, 'São Tomé e Príncipe', 'Republic', 'Miguel Trovoada', 3172, 'ST'),
('SUR', 'Suriname', 'South America', 'South Amer', 163265, 1975, 417000, 71.4, 870, 706, 'Suriname', 'Republic', 'Ronald Venetiaan', 3243, 'SR'),
('SVK', 'Slovakia', 'Europe', 'Eastern Eu', 49012, 1993, 5398700, 73.7, 20594, 19452, 'Slovensko', 'Republic', 'Rudolf Schuster', 3209, 'SK'),
('SVN', 'Slovenia', 'Europe', 'Southern E', 20256, 1991, 1987800, 74.9, 19756, 18202, 'Slovenija', 'Republic', 'Milan Kucan', 3212, 'SI'),
('SWE', 'Sweden', 'Europe', 'Nordic Cou', 449964, 836, 8861400, 79.6, 226492, 227757, 'Sverige', 'Constitutional Monarchy', 'Carl XVI Gustaf', 3048, 'SE'),
('SWZ', 'Swaziland', 'Africa', 'Southern A', 17364, 1968, 1008000, 40.4, 1206, 1312, 'kaNgwane', 'Monarchy', 'Mswati III', 3244, 'SZ'),
('SYC', 'Seychelles', 'Africa', 'Eastern Af', 455, 1976, 77000, 70.4, 536, 539, 'Sesel/Seychelles', 'Republic', 'France-Albert René', 3206, 'SC'),
('SYR', 'Syria', 'Asia', 'Middle Eas', 185180, 1941, 16125000, 68.5, 65984, 64926, 'Suriya', 'Republic', 'Bashar al-Assad', 3250, 'SY'),
...
('TCD', 'Chad', 'Africa', 'Central Af', 1284000, 1960, 7651000, 50.5, 1208, 1102, 'Tchad/Tshad', 'Republic', 'Idriss Déby', 3337, 'TD'),
('TGO', 'Togo', 'Africa', 'Western Af', 56785, 1960, 4629000, 54.7, 1449, 1400, 'Togo', 'Republic', 'Gnassingbé Eyadéma', 3332, 'TG'),
('THA', 'Thailand', 'Asia', 'Southeast ', 513115, 1350, 61399000, 68.6, 116416, 153907, 'Prathet Thai', 'Constitutional Monarchy', 'Bhumibol Adulyadej', 3320, 'TH'),
('TJK', 'Tajikistan', 'Asia', 'Southern a', 143100, 1991, 6188000, 64.1, 1990, 1056, 'Toçikiston', 'Republic', 'Emomali Rahmonov', 3261, 'TJ'),
('TKL', 'Tokelau', 'Oceania', 'Polynesia', 12, 0, 2000, 0, 0, 0, 'Tokelau', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 3333, 'TK'),
('TKM', 'Turkmenistan', 'Asia', 'Southern a', 488100, 1991, 4459000, 60.9, 4397, 2000, 'Türkmenostan', 'Republic', 'Saparmurad Nijazov', 3419, 'TM'),
('TMP', 'East Timor', 'Asia', 'Southeast ', 14874, 0, 885000, 46, 0, 0, 'Timor Timur', 'Administrated by the UN', 'José Alexandre Gusmão', 1522, 'TP'),
...
('TUN', 'Tunisia', 'Africa', 'Northern A', 163610, 1956, 9586000, 73.7, 20026, 18898, 'Tunis/Tunisie', 'Republic', 'Zine al-Abidine Ben Ali', 3349, 'TN'),
('TUR', 'Turkey', 'Asia', 'Middle Eas', 774815, 1923, 66591000, 71, 210721, 189122, 'Türkiye', 'Republic', 'Ahmet Necdet Sezer', 3358, 'TR'),
('TUV', 'Tuvalu', 'Oceania', 'Polynesia', 26, 1978, 12000, 66.3, 6, 0, 'Tuvalu', 'Constitutional Monarchy', 'Elisabeth II', 3424, 'TV'),
('TWN', 'Taiwan', 'Asia', 'Eastern As', 36188, 1945, 22256000, 76.4, 256254, 263451, 'T’ai-wan', 'Republic', 'Chen Shui-bian', 3263, 'TW'),
('TZA', 'Tanzania', 'Africa', 'Eastern Af', 883749, 1961, 33517000, 52.3, 8005, 7388, 'Tanzania', 'Republic', 'Benjamin William Mkapa', 3306, 'TZ'),
('UGA', 'Uganda', 'Africa', 'Eastern Af', 241038, 1962, 21778000, 42.9, 6313, 6887, 'Uganda', 'Republic', 'Yoweri Museveni', 3425, 'UG'),
('UKR', 'Ukraine', 'Europe', 'Eastern Eu', 603700, 1991, 50456000, 66, 42168, 49677, 'Ukrajina', 'Republic', 'Leonid Kutšma', 3426, 'UA'),
('UMI', 'United States Minor Outlying Islands', 'Oceania', 'Micronesia', 16, 0, 0, 0, 0, 0, 'United States Minor Outlying Islands', 'Dependent Territory of the US', 'George W. Bush', 0, 'UM'),
('URY', 'Uruguay', 'South America', 'South Amer', 175016, 1828, 3337000, 75.2, 20831, 19967, 'Uruguay', 'Republic', 'Jorge Batlle Ibáñez', 3492, 'UY'),
('USA', 'United States', 'North America', 'North Amer', 9363520, 1776, 278357000, 77.1, 8510700, 8110900, 'United States', 'Federal Republic', 'George W. Bush', 3813, 'US'),
('UZB', 'Uzbekistan', 'Asia', 'Southern a', 447400, 1991, 24318000, 63.7, 14194, 21300, 'Uzbekiston', 'Republic', 'Islam Karimov', 3503, 'UZ'),
('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern E', 0.4, 1929, 1000, 0, 9, 0, 'Santa Sede/Città del Vaticano', 'Independent Church State', 'Johannes Paavali II', 3538, 'VA'),
...
('VEN', 'Venezuela', 'South America', 'South Amer', 912050, 1811, 24170000, 73.1, 95023, 88434, 'Venezuela', 'Federal Republic', 'Hugo Chávez Frías', 3539, 'VE'),
...
('VNM', 'Vietnam', 'Asia', 'Southeast ', 331689, 1945, 79832000, 69.3, 21929, 22834, 'Viêt Nam', 'Socialistic Republic', 'Trân Duc Luong', 3770, 'VN'),
...
('YEM', 'Yemen', 'Asia', 'Middle Eas', 527968, 1918, 18112000, 59.8, 6041, 5729, 'Al-Yaman', 'Republic', 'Ali Abdallah Salih', 1780, 'YE'),
('YUG', 'Yugoslavia', 'Europe', 'Southern E', 102173, 1918, 10640000, 72.4, 17000, 0, 'Jugoslavija', 'Federal Republic', 'Vojislav Koštunica', 1792, 'YU'),
('ZAF', 'South Africa', 'Africa', 'Southern A', 1221040, 1910, 40377000, 51.1, 116729, 129092, 'South Africa', 'Republic', 'Thabo Mbeki', 716, 'ZA'),
('ZMB', 'Zambia', 'Africa', 'Eastern Af', 752618, 1964, 9169000, 37.2, 3377, 3922, 'Zambia', 'Republic', 'Frederick Chiluba', 3162, 'ZM'),
('ZWE', 'Zimbabwe', 'Africa', 'Eastern Af', 390757, 1980, 11669000, 37.8, 5951, 8670, 'Zimbabwe', 'Republic', 'Robert G. Mugabe', 4068, 'ZW');
...
CREATE TABLE `language` (
  ...
  `Lang_Spoken` varchar(25) NOT NULL,
  `Main_Lang` varchar(1) NOT NULL,
  `Lang_Percent` decimal(4,1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `language` (`Con_Code`, `Lang_Spoken`, `Main_Lang`, `Lang_Percent`) VALUES
('ABW', 'Dutch', 'T', '5.3'),
('AFG', 'Balochi', 'F', '0.9'),
('AGO', 'Ambo', 'F', '2.4'),
('AIA', 'English', 'T', '0.0'),
...
CREATE TABLE `languages` (
  ...
  `Main_Lang` enum('F','T') NOT NULL DEFAULT 'F',
  `Lang_percent` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `languages` (`Con_code`, `Lang_Spoken`, `Main_Lang`, `Lang_percent`) VALUES
('', '', '', 0),
('', 'coo', '', 27),
('', 'fdgfd', '', 223),
('', 'yuguyguy', '', 7),
...
ALTER TABLE `languages`
  ADD PRIMARY KEY (`Con_code`,`Lang_Spoken`);
COMMIT;
